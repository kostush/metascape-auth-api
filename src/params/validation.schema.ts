...
export const validationSchema = Joi.object({
  ...
  [PARAMETERS.LOGGER_LEVEL]: Joi.string().optional(),
  [PARAMETERS.LOGGER_TRANSPORT_CONSOLE_IS_USED]: Joi.boolean().optional(),
  [PARAMETERS.LOGGER_TRANSPORT_CONSOLE_LEVEL]: Joi.string().optional(),
  [PARAMETERS.LOGGER_TRANSPORT_FILE_FILENAME]: Joi.string().optional(),
  [PARAMETERS.LOGGER_TRANSPORT_FILE_LEVEL]: Joi.string().optional(),
  [PARAMETERS.LOGGER_TRANSPORT_LOGSTASH_HOST]: Joi.string().optional(),
  [PARAMETERS.LOGGER_TRANSPORT_LOGSTASH_PORT]: Joi.number().optional(),
  [PARAMETERS.LOGGER_TRANSPORT_LOGSTASH_LEVEL]: Joi.string().optional(),
